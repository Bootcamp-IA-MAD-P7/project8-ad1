# Consignas originales: Proyecto Data Analyst

> Este documento conserva las consignas recibidas al clonar el proyecto. Es una
> fuente de contexto, no una especificación SDD aprobada. Las ambigüedades y los
> niveles opcionales deben concretarse en `specs/` antes de implementarse.
