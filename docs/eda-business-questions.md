...
| 2026-09-03 | Concentración por anfitrión y disponibilidad publicada | activa | Tras responder las preguntas P1 y consolidar el EDA esencial, ambas preguntas P2/P3 permanecen sin resolver. Su cobertura desigual y sus límites interpretativos requieren un análisis específico. | Se documentan como extensiones opcionales y no bloquean el cierre de #14. |
